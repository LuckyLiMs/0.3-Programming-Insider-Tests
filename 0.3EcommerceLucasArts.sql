...
CREATE TABLE `cart` (
  ...
  CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `tbl_usuario` (`usu_id`)
...
CREATE TABLE `tbl_usuario` (
  ...
  `usu_email` varchar(110) DEFAULT NULL,
  ...
  `usu_cidade` varchar(45) DEFAULT NULL,
  `usu_estado` varchar(45) DEFAULT NULL,
  `usu_endereco` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`usu_id`)
...
-- Dump completed on 2024-04-29 21:32:30
